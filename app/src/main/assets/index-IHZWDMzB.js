const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HomeView-BBRNeEQy.js","./index-BnQGTW39.js","./FileManagerView-DLX1C-iw.js","./ApkManagerView-BV4ca3ZK.js","./IconManagerView-D7bUh7Cr.js","./SettingsView-eCitj6Us.js","./IconGenView-VbdqrZwq.js"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const _hoisted_2 = { class: "sidebar-nav" };
const _hoisted_3 = ["innerHTML"];
const _hoisted_4 = { class: "nav-label" };
const _hoisted_5 = { class: "sidebar-footer" };
const _hoisted_6 = { class: "main-area" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const serverOnline = /* @__PURE__ */ ref(false);
    const serverChecking = /* @__PURE__ */ ref(true);
    const navItems = [
    ...
    onMounted(() => {
      checkServer();
      timer = setInterval(checkServer, 1e4);
    });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("aside", {
          class: normalizeClass(["sidebar", { open: sidebarOpen.value }])
        }, [
          _cache[4] || (_cache[4] = createStaticVNode('<div class="sidebar-header"><svg class="logo-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"></rect><path d="M3 9h18M9 3v18"></path></svg><span class="logo-text">E-Ink Launcher</span></div>', 1)),
          ...
          createBaseVNode("div", _hoisted_5, [
            createVNode(_component_router_link, {
              to: "/icon-gen",
              class: "nav-item nav-item-accent",
              onClick: _cache[1] || (_cache[1] = ($event) => sidebarOpen.value = false)
            }, {
              default: withCtx(() => [
                createBaseVNode("span", {
                  class: "nav-icon",
                  innerHTML: iconGenSvg
                }),
                _cache[3] || (_cache[3] = createBaseVNode("span", { class: "nav-label" }, "图标生成器", -1))
              ]),
              _: 1
            })
          ])
        ...
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("header", _hoisted_7, [
            createBaseVNode("button", {
              class: "menu-toggle",
              onClick: _cache[2] || (_cache[2] = ($event) => sidebarOpen.value = !sidebarOpen.value)
            }, [..._cache[5] || (_cache[5] = [
              createBaseVNode("svg", {
                viewBox: "0 0 24 24",
                fill: "none",
            ...
            createBaseVNode("h1", _hoisted_8, toDisplayString(currentPageTitle.value), 1),
            createBaseVNode("div", {
              class: normalizeClass(["server-status", serverOnline.value ? "online" : serverChecking.value ? "checking" : "offline"])
            }, [
              _cache[6] || (_cache[6] = createBaseVNode("span", { class: "status-dot" }, null, -1)),
              createTextVNode(" " + toDisplayString(serverOnline.value ? "已连接" : serverChecking.value ? "检测中..." : "未连接"), 1)
            ], 2)
          ]),
...
const routes = [
  { path: "/", name: "home", component: () => __vitePreload(() => import("./HomeView-BBRNeEQy.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url) },
  { path: "/fm", name: "fm", component: () => __vitePreload(() => import("./FileManagerView-DLX1C-iw.js"), true ? __vite__mapDeps([2,1]) : void 0, import.meta.url) },
  { path: "/apk", name: "apk", component: () => __vitePreload(() => import("./ApkManagerView-BV4ca3ZK.js"), true ? __vite__mapDeps([3,1]) : void 0, import.meta.url) },
  { path: "/icons", name: "icons", component: () => __vitePreload(() => import("./IconManagerView-D7bUh7Cr.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url) },
  { path: "/settings", name: "settings", component: () => __vitePreload(() => import("./SettingsView-eCitj6Us.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url) },
  { path: "/icon-gen", name: "icon-gen", component: () => __vitePreload(() => import("./IconGenView-VbdqrZwq.js"), true ? __vite__mapDeps([6,1]) : void 0, import.meta.url) }
];
